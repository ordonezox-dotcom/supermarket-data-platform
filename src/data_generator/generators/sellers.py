...
def generate_sellers(
    ...
    with conn.cursor() as cursor:
        ...
        if existing_count > 0:
            ...
            print(
                f"Vendedores omitidos: ya existen "
        ...
        for store_id in store_ids:
            ...
            for _ in range(sellers_per_store):
                ...
                # ============================================
                # FECHA DE CONTRATACIÓN COHERENTE
                #
                # Todas nuestras ventas históricas empiezan
                # en 2024.
                #
                # Por eso generamos vendedores contratados
